...
plot(FebCons$Date_Time, FebCons$Voltage, xlab="datetime", ylab="Volage", type="l")
plot(FebCons$Date_Time, FebCons$Global_reactive_power, xlab="datetime", ylab="Global_reactive_Power", type="l")
